    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li>
                    <a href="/new" class="nav-link px-2 text-white d-flex align-items-center column-gap-2">
            ...
            <?php if ($auth->check()) {   ?>
                ...
                <a  class="username d" href="/profile?id=<?php echo $user->getId()?>"> <?php echo $user->getName()?></a>
