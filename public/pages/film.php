...
<div class="container">
    <div class="row">
        <div class="col-lg-5">
            <video class="w-100 mt-5" src=<?="../uploads/films/".$film->getFilmPath();?> controls muted></video>
        </div>
        <div class="col-lg-7">
            <h1 class="text text-center text-bg-dark"><?=$film->getName();?></h1>
       ...
       <!-- <p>опубликованно : <?php /*=$author->getNickname();*/?></p>-->

            <p>Опубликованно пользователем <?=$film->getAuthor()->getNickname();?></p>
        </div>
    </div>
